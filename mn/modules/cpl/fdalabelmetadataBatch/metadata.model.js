...
const ipfsdata = newconn.model("ipfsdata", ipfsSchema, 'tbl_blockChainIpfsData');
const fdaMetaData = newconn.model("fdametadata", metaSchema, 'tbl_fdalebelmetadata');
const priceList = newconn.model("priceList", priceSchema, 'tbl_priceList');
const orderCreate = newconn.model("orderCreate", orderSchema, 'tbl_order');
const paymentModeDetails = newconn.model("paymentModeDetails", paymentModeSchema, 'tbl_paymentModeDetails');
const discountDetails = newconn.model("discountDetails", discountSchema, 'tbl_userDiscount');
