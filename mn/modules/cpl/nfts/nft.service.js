...
(PDFDocument = require("pdfkit")), (SVGtoPDF = require("svg-to-pdfkit"));
...
const { getFactoryInfo } = require("./nftCustom.model");
...
const {
  ...
  SuperAdmin,
  CompanyVerified,
} = require("../../common/user/user.model");
...
let {
  ...
  metaSchema,
  invoiceNewSchema,
  assignContainerByFactoryIdsSchema,
  getNftsSchema,
  getRegisterSchema,
  assignContainerToOthersSchema,
  ipfsVerifySchema,
  saveNftsDataSchema,
  saveNftsPalletsDataSchema,
  saveNftsMastersDataSchema,
  saveNftsInnersDataSchema,
  saveNftsDrugsDataSchema,
  saveNftsReportDataSchema,
  ipfsUpdatedVerifySchema,
} = require("./nft.model");
...
let self = (module.exports = {
  createDatabase: (databaseName) => {
    ...
    const saveNftsReportData = db.model(
      "saveNftsReportData",
      saveNftsReportDataSchema,
      "tbl_save_nfts_reports"
    );
    const saveNftsDataInChain = db.model(
      "saveNftsDataInChain",
      saveNftsDataSchema,
      "tbl_save_nfts_container"
    );
    const saveNftsPalletsInChain = db.model(
      "saveNftsPalletsInChain",
      saveNftsPalletsDataSchema,
      "tbl_save_nfts_pallets"
    );
    const saveNftsMastersInChain = db.model(
      "saveNftsMastersInChain",
      saveNftsMastersDataSchema,
      "tbl_save_nfts_masterCartons"
    );
    const saveNftsInnersDataInChain = db.model(
      "saveNftsInnersDataInChain",
      saveNftsInnersDataSchema,
      "tbl_save_nfts_InnerCartons"
    );
    const saveNftsDrugsDataInChain = db.model(
      "saveNftsDrugsDataInChain",
      saveNftsDrugsDataSchema,
      "tbl_save_nfts_Drugs"
    );
    const ipfsUpdatedVerify = db.model(
      "ipfsUpdatedVerify",
      ipfsUpdatedVerifySchema,
      "tbl_blockChainUpdatedIpfsData"
    );
    const ipfsverifydata = db.model(
      "ipfsverifydata",
      ipfsVerifySchema,
      "tbl_blockChainIpfsData"
    );
    const assignContainerToOthersData = db.model(
      "assignContainerToOthersData",
      assignContainerToOthersSchema,
      "tbl_assignContainerToOthersById"
    );
    const factoryByContainerSchema = db.model(
      "factoryByContainerSchema",
      assignContainerByFactoryIdsSchema,
      "tbl_order"
    );
    const generatedUpdateStatus = db.model(
      "generatedUpdateStatus",
      invoiceNewSchema,
      "tbl_order"
    );
    const assignMetaData = db.model(
      "assignMetaData",
      metaSchema,
      "tbl_fdalebelmetadata"
    );
    const assignFactotry = db.model(
      "assignFactotry",
      factotrySchema,
      "tbl_assignContainerFactoryById"
    );
    const getOrder = db.model("getOrder", orderSchema, "tbl_order");
    const getNftsArray = db.model(
      "getNftsArray",
      getNftsSchema,
      "tbl_nftgeneratenumber"
    );
    ...
    const productModel = db.model(
      "productModel",
      productSchema,
      "tbl_products"
    );
    const printerAppNewModel = db.model(
      "printerAppNewModel",
      printerAppNewSchema,
      "tbl_printerNewData"
    );
  ...
  updateDeliveryIntentNoData: async (data, databaseName, typedata) => {
    var deferred = Q.defer();
  ...
  getInvoicePrintData: async (data, databaseName, typedata) => {
    var deferred = Q.defer();
  ...
  listPrintedAppTransactionData: async (data, databaseName, typedata) => {
    var deferred = Q.defer();
      ...
      printerAppNewModel
        .aggregate([
          ...
          },
          {
            $lookup: {
              from: "tbl_products",
              let: { productNewDetails: "$productDetails11" },
              pipeline: [
                {
                  $match: {
                    $expr: [{ _id: "$$productNewDetails.productId" }],
                  },
                },
                {
                  $project: {
  ...
  savePrintedAppTransactionData: async (data, databaseName, typedata) => {
    var deferred = Q.defer();
    ...
    try {
      ...
      (data.userId = mongoose.Types.ObjectId(data.userId)),
        printerAppNewModel.find(
          { deliveryIntentNo: data.deliveryIntentNo },
          async (err, findResult) => {
            if (err) {
              let obj = { status: 0, data: result };
              deferred.resolve(obj);
              ...
              printerAppNewModel.create(data, async (err, result) => {
                if (err) {
                  let obj = { status: 0, data: result };
                  deferred.resolve(obj);
                } else {
  ...
  getPrintedNfts: async (data, databaseName, typedata) => {
    var deferred = Q.defer();
    ...
    try {
      ...
      generatedUpdateStatus
        .aggregate([
          ...
          {
            $lookup: {
              from: "tbl_nftgeneratenumber",
              localField: "fdalebelId",
              foreignField: "fdalebelId",
              as: "nftgeneratenumberData",
            },
          },
          {
            $project: {
              _id: 0,
              nftgeneratenumberData: "$nftgeneratenumberData",
            },
          },
          {
            $unwind: "$nftgeneratenumberData",
          },
          {
            $replaceRoot: {
              newRoot: {
                $mergeObjects: [
                  {
                    $first:
                      "$nftgeneratenumberData.assignContainerByFactoryIds.nftData",
                  },
                ],
              },
            },
  ...
  updateStatusGenratedNfts: async (data, databaseName, typedata) => {
    var deferred = Q.defer();
  ...
  getContainersData: async (data) => {
    ...
    try {
      var paramsContainers = {
        ...
        Delimiter: "/",
        Prefix:
          "shashikant_company_pvt_ltd1/628f1a6a5871b5d78c6c6196/containers/",
      };
  ...
  getMasterCartonsData: async (data) => {
    ...
    try {
      var paramsMasterCartons = {
        ...
        Delimiter: "/",
        Prefix:
          "shashikant_company_pvt_ltd1/628f1a6a5871b5d78c6c6196/masterCartons/",
      };
  ...
  getInnerCartonsData: async (data) => {
    ...
    try {
      var paramsInnerCartons = {
        ...
        Delimiter: "/",
        Prefix:
          "shashikant_company_pvt_ltd1/628f1a6a5871b5d78c6c6196/innerCartons/",
      };
  ...
  genrateAllDocsPdf: async (data) => {
    ...
    try {
      const [
        getContainersData,
        getPalletsData,
        getMasterCartonsData,
        getInnerCartonsData,
        getDrugsData,
      ] = await Promise.all([
        self.getContainersData(data.schema),
        self.getPalletsData(data.schema),
        self.getMasterCartonsData(data.schema),
        self.getInnerCartonsData(data.schema),
        self.getDrugsData(data.schema),
      ]);

      let mergeArray = [
        ...getContainersData.data,
        ...getPalletsData.data,
        ...getMasterCartonsData.data,
        ...getInnerCartonsData.data,
        ...getDrugsData.data,
      ];
      ...
      .aggregate([
        ...
        { $unwind: "$company_info" },
        {
          $project: {
            ...
            userId: 1,
            companyName: {
              $arrayElemAt: ["$company_info.registerInfo.companyName", 0],
            },
            nftData: {
              $arrayElemAt: ["$assignContainerByFactoryIds.nftData", 0],
            },
          },
        },
      ])
        ...
        if (err || result == null || result.length == 0) {
          ...
          if (nftData.hasOwnProperty("containers")) {
            var writeStream = fs.createWriteStream(
              "./public/pdfsData/" + companyName + "_containers.csv"
            );
            let filterArr = [];
            nftData.containers.forEach((val) => {
              filterArr.push({
                originalURL:
                  "https://blokchi.com/nft-verify/" + slug + "/" + val.ipfsHash,
              });
            });
            let shortUrl = await self.shortUrls(filterArr);
            for (let i = 0; i < shortUrl.length; i++) {
              writeStream.write(
                "https://4en6.short.gy/" + shortUrl[i].path + "\n"
              );
            }
            let params = {
              Bucket:
          ...
          if (nftData.hasOwnProperty("pallets")) {
            var writeStream = fs.createWriteStream(
              "./public/pdfsData/" + companyName + "_pallets.csv"
            );
            let filterArr = [];
            ...
            let params = {
              Bucket:
                mainBucket + "/" + companyName + "/" + fdalebelId + "/pallets",
              ACL: "public-read",
              Region: "us-east-1",
              Key: fdalebelId + ".csv",
              Body: fs.createReadStream(writeStream.path),
          ...
          if (nftData.hasOwnProperty("masterCartons")) {
            var writeStream = fs.createWriteStream(
              "./public/pdfsData/" + companyName + "_masterCartons.csv"
            );
            let filterArr = [];
          ...
          if (nftData.hasOwnProperty("innerCartons")) {
            var writeStream = fs.createWriteStream(
              "./public/pdfsData/" + companyName + "_innerCartons.csv"
            );
            let filterArr = [];
          ...
          if (nftData.hasOwnProperty("drugs")) {
            ...
            let getChunkArray = await self.changeDataAsChunk(
              filterArr,
              mainBucket,
              companyName,
              fdalebelId
  ...
  changeDataAsChunk: async function (
    ...
    if (data == undefined || (Array.isArray(data) && data.length == 0)) {
      var writeStream = fs.createWriteStream(
        "./public/pdfsData/" + companyName + "_drugs.csv"
      );
    ...
    getNftsArray.findOne(
      ...
      (err, result) => {
        if (err) {
          ...
          nftDataObj.data.container = result.assignContainerByFactoryIds[0]
            .nftData.container
            ? result.assignContainerByFactoryIds[0].nftData.container.map(
                (val) =>
                  "https://blokchi.com/nft-verify/" + slug + "/" + val.ipfsHash
              )
            : [];
          nftDataObj.data.pallets = result.assignContainerByFactoryIds[0]
            .nftData.pallets
            ? result.assignContainerByFactoryIds[0].nftData.pallets.map(
                (val) =>
                  "https://blokchi.com/nft-verify/" + slug + "/" + val.ipfsHash
              )
            : [];
          nftDataObj.data.masterCartons = result.assignContainerByFactoryIds[0]
            .nftData.masterCartons
            ? result.assignContainerByFactoryIds[0].nftData.masterCartons.map(
                (val) =>
                  "https://blokchi.com/nft-verify/" + slug + "/" + val.ipfsHash
              )
            : [];
          nftDataObj.data.innerCartons = result.assignContainerByFactoryIds[0]
            .nftData.innerCartons
            ? result.assignContainerByFactoryIds[0].nftData.innerCartons.map(
                (val) =>
                  "https://blokchi.com/nft-verify/" + slug + "/" + val.ipfsHash
              )
            : [];
          nftDataObj.data.drugs = result.assignContainerByFactoryIds[0].nftData
            .drugs
            ? result.assignContainerByFactoryIds[0].nftData.drugs.map(
                (val) =>
                  "https://blokchi.com/nft-verify/" + slug + "/" + val.ipfsHash
              )
            : [];
  ...
  export: async (data, databaseName) => {
    ...
    let dataData = await self.viewContainerByfdalebelId(
      data.fdalebelId,
      databaseName
    );
      ...
      .exec(async (err, result) => {
        if (err) {
          ...
          let filterKey = filterData.filter((val, ind) => {
            if (val["nftVerifyByUserId"] != undefined) return val;
          });

          let rectiFyData = filterKey[filterKey.length - 1];
          console.log("dev......", rectiFyData);

          let nftVerifyByUserIdDetails = await User.find({
            _id: mongoose.Types.ObjectId(
              rectiFyData.nftVerifyByUserId[0].verifyByUserId
            ),
          }).exec();
          rectiFyData.nftVerifyByUserIdDetails = nftVerifyByUserIdDetails;

          console.log(
            "nftVerifyByUserIdDetails......",
            nftVerifyByUserIdDetails
          );
            ...
            if (data.type == "all") {
              var obj = {
                ...
                data: {
                  fdaId: data.fdaId,
                  packagingDetails:
                    result[0].productDetails[0].packagingDetails,
                  newprductDetails:
                    containersPushData.length > 0
                      ? containersPushData[0].productDetails
                      : [],
                  ...
                  containers: {
                    quantity: containersPushData.length,
                    burned: _.filter(containersPushData, { status: 3 }).length,
                    verified: _.filter(containersPushData, { status: 2 })
                      .length,
                    balance: _.filter(containersPushData, { status: 1 }).length,
                    nftsFlag: containersPushData,
                  },
                  ...
                  innerCartons: {
                    quantity: innerCartonsPushData.length,
                    burned: _.filter(innerCartonsPushData, { status: 3 })
                      .length,
                    verified: _.filter(innerCartonsPushData, { status: 2 })
                      .length,
                    balance: _.filter(innerCartonsPushData, { status: 1 })
                      .length,
                    nftsFlag: innerCartonsPushData,
                  },
        ...
        .exec(async (err, result) => {
          if (err) {
            ...
            console.log(
              ...
              data,
              saveVerifyBox,
              currentSaveVerifyBox,
              packagingDetails,
              previousBox,
              currentBox,
              "currentBoxcurrentBoxcurrentBox"
            );
            if (result.length == 0) {
  ...
  verifyHashUserNftsData: async (data, databaseName) => {
    var deferred = Q.defer();
        ...
        if (err) {
          ...
          await Promise.all(
            result.map(async (val, ind) => {
              let mapData = await User.findOne(
                { _id: mongoose.Types.ObjectId(val.manufacturerId) },
  ...
  hashBurnByUserId: async (data, databaseName) => {
    ...
    try {
      ...
      let userDetails = await User.findOne({
        email: data.nftBurnByUserEmailId,
      }).exec();
        ...
        .findOneAndUpdate(
          { ipfsHash: data.ipfsHash },
          {
            $set: {
              status: 3,
              nftBurnTransactionHash:
                "craevffdbvby97ihu43jgvhuckjdsvhsdgviygsa",
            ...
            if (err) {
              ...
              await getNftsArray
                .findOneAndUpdate(
                  ...
                  {
                    $set: {
                      "assignContainerByFactoryIds.$.assignContainerStatus": 2,
                    },
                  },
                  { new: true }
                )
          ...
          getNftsArray.create(finalData, async (err, result) => {
            if (err) {
              ...
              await generatedUpdateStatus
                ...
                .exec(async (err, result1) => {});
              let getResponse = await self.genratePdfs(
                data.fdalebelId,
                databaseName,
                slug
              );
  ...
  viewContainerCompanyFactoryById: async (data, databaseName) => {
    ...
    const getFactories = await Promise.all([
      self.getFactoryIds(data, databaseName),
    ]);
      ...
      .aggregate([
        ...
        // { $unwind: "$userDetails" },
        {
          $project: {
            ...
            productId: 1,
            fdalebelId: 1,
            generatedNftStatus: { $first: "$orderDetails.generatedNftStatus" },
            ...
            packagingStandardValue: {
              $first: "$fdaDetails.packagingStandardValue",
            },
      ...
      .aggregate([
        ...
        },
        {
          $project: {
            ...
            fdaId: "$fdaId" ? "$fdaId" : "",
            deliveryIntentNo: "$deliveryIntentNo" ? "$deliveryIntentNo" : "",
            status: 1,
            createdDate: 1,
            updateDate: 1,
          },
        ...
        {
          $lookup: {
            from: "tbl_printerNewData",
            localField: "deliveryIntentNo",
