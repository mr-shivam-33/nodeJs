...
const ManufacturerInfo = mongoose.model(
  "manufacturerInfo",
  manufacturerfactoryInfoSchema,
  "tbl_company_info"
);
const ContractUserInfo = mongoose.model(
  "contractUserInfo",
  contractUserSchema,
  "tbl_user"
);
const UserMemberInfo = mongoose.model(
  "userMemberInfo",
  userMemberSchema,
  "tbl_user"
);
const UserInfo = mongoose.model("userInfo", userRegisterSchema, "tbl_user");
const AddressInfo = mongoose.model(
  "addressInfo",
  addressInfoSchema,
  "tbl_user"
);
...
const CustomerVerifyInfo = mongoose.model(
  "customerVerifyInfo",
  ipfsVerifyByCustomerSchema,
